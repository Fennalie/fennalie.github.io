...
var games = {
  ...
  '7': { 'name': "Century:Eastern Wonders", 'maxplayers': 4, 'minplayers': 4, 'time': 2, 'kid': false, 'competitive': false },
  '8': { 'name': "Chess", 'maxplayers': 2, 'minplayers': 2, 'time': 3, 'kid': false, 'competitive': true },
  '9': { 'name': "Code Names", 'maxplayers': 8, 'minplayers': 4, 'time': 1, 'kid': true, 'competitive': false },
  ...
  '17': { 'name': "Hanabi", 'maxplayers': 5, 'minplayers': 4, 'time': 1, 'kid': true, 'competitive': false },
  '18': { 'name': "I would fight the dragon", 'maxplayers': 8, 'minplayers': 5, 'time': 2, 'kid': false, 'competitive': true },
  '19': { 'name': "Llamas Unleashed", 'maxplayers': 8, 'minplayers': 4, 'time': 2, 'kid': false, 'competitive': true },
  '20': { 'name': "Monopoly Deal", 'maxplayers': 5, 'minplayers': 4, 'time': 1, 'kid': true, 'competitive': true },
  '21': { 'name': "Pandemic", 'maxplayers': 4, 'minplayers': 2, 'time': 3, 'kid': true, 'competitive': false },
  '22': { 'name': "Patchwork", 'maxplayers': 2, 'minplayers': 2, 'time': 2, 'kid': true, 'competitive': true },
  '23': { 'name': "Pictionary", 'maxplayers': 8, 'minplayers': 6, 'time': 2, 'kid': true, 'competitive': false },
  '24': { 'name': "Pictureka", 'maxplayers': 7, 'minplayers': 4, 'time': 2, 'kid': true, 'competitive': true },
  '25': { 'name': "Power Grid", 'maxplayers': 6, 'minplayers': 4, 'time': 3, 'kid': false, 'competitive': true },
  '26': { 'name': "Risk", 'maxplayers': 5, 'minplayers': 4, 'time': 3, 'kid': false, 'competitive': true },
  '27': { 'name': "Saboteur", 'maxplayers': 10, 'minplayers': 5, 'time': 2, 'kid': true, 'competitive': true },
  '28': { 'name': "Scrabble", 'maxplayers': 4, 'minplayers': 2, 'time': 3, 'kid': false, 'competitive': true },
  '29': { 'name': "Sequence", 'maxplayers': 12, 'minplayers': 3, 'time': 1, 'kid': true, 'competitive': true },
  '30': { 'name': "Settlers of Catan", 'maxplayers': 4, 'minplayers': 3, 'time': 3, 'kid': true, 'competitive': true },
  '31': { 'name': "Spot it!", 'maxplayers': 6, 'minplayers': 4, 'time': 1, 'kid': true, 'competitive': true },
  '32': { 'name': "Terraforming Mars", 'maxplayers': 5, 'minplayers': 3, 'time': 3, 'kid': false, 'competitive': true },
  '33': { 'name': "The Digital Game", 'maxplayers': 4, 'minplayers': 2, 'time': 1, 'kid': true, 'competitive': true },
  '34': { 'name': "The Grizzled", 'maxplayers': 5, 'minplayers': 3, 'time': 1, 'kid': false, 'competitive': false },
  '35': { 'name': "Ticket to Ride", 'maxplayers': 5, 'minplayers': 4, 'time': 2, 'kid': true, 'competitive': true },
  '36': { 'name': "Twister", 'maxplayers': 4, 'minplayers': 4, 'time': 1, 'kid': true, 'competitive': true },
  '37': { 'name': "Uno Flip", 'maxplayers': 10, 'minplayers': 3, 'time': 1, 'kid': true, 'competitive': true },
  '38': { 'name': "Uno Stack", 'maxplayers': 10, 'minplayers': 2, 'time': 1, 'kid': true, 'competitive': true },
  '39': { 'name': "Unstable Unicorns", 'maxplayers': 8, 'minplayers': 4, 'time': 2, 'kid': false, 'competitive': true },
  '40': { 'name': "Werewolf", 'maxplayers': 75, 'minplayers': 7, 'time': 2, 'kid': false, 'competitive': true },
